...
export interface UploadFileParams {
  fileName: string;
  contentType: string;
  bucketType?: 'meetup-posters' | 'profile-photos' | 'college-logos' | 'meetup-photos' | 'meetup-reports' | 'cloud-club-logos' | 'cloud-club-files' | 'spotlight-images' | 'badge-images';
}
...
export async function uploadFileToS3(
  file: File,
  bucketType: 'meetup-posters' | 'profile-photos' | 'college-logos' | 'meetup-photos' | 'meetup-reports' | 'cloud-club-logos' | 'cloud-club-files' | 'spotlight-images' | 'badge-images' = 'meetup-posters'
): Promise<string> {
  try {
