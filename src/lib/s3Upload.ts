...
export interface UploadFileParams {
  fileName: string;
  contentType: string;
  bucketType?: 'meetup-posters' | 'profile-photos' | 'college-logos' | 'meetup-photos' | 'meetup-reports';
}
...
export async function uploadFileToS3(
  file: File,
  bucketType: 'meetup-posters' | 'profile-photos' | 'college-logos' | 'meetup-photos' | 'meetup-reports' = 'meetup-posters'
): Promise<string> {
  try {
