...
resource "aws_api_gateway_resource" "meetups_id_participants" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  parent_id   = aws_api_gateway_resource.meetups_id.id
...
resource "aws_api_gateway_method" "meetups_id_delete" {
  rest_api_id   = aws_api_gateway_rest_api.api.id
  resource_id   = aws_api_gateway_resource.meetups_id.id
  http_method   = "DELETE"
  authorization = "NONE"
...
resource "aws_api_gateway_method" "meetups_id_participants_get" {
  rest_api_id   = aws_api_gateway_rest_api.api.id
...
resource "aws_api_gateway_integration" "meetups_id_delete_lambda" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.meetups_id.id
  http_method = aws_api_gateway_method.meetups_id_delete.http_method
...
# Participants endpoint integrations
resource "aws_api_gateway_integration" "meetups_id_participants_lambda" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.meetups_id_participants.id
  http_method = aws_api_gateway_method.meetups_id_participants_get.http_method
...
resource "aws_api_gateway_integration" "meetups_id_participants_options_lambda" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.meetups_id_participants.id
...
resource "aws_api_gateway_method_response" "meetups_id_participants_options_200" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.meetups_id_participants.id
  http_method = aws_api_gateway_method.meetups_id_participants_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "meetups_id_participants_options" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.meetups_id_participants.id
  http_method = aws_api_gateway_method.meetups_id_participants_options.http_method
...
resource "aws_api_gateway_deployment" "api" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_integration.upload_options_lambda.id,
